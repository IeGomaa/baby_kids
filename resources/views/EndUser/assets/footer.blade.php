...
<!--main-->
<script src="{{asset('EndUserAssets/js/main/jquery.min.js')}}"></script> <!--Jquery-->
<script src="{{asset('EndUserAssets/js/main/jquery-ui.js')}}"></script> <!--Jquery UI-->
<script src="{{asset('EndUserAssets/js/main/excanvas.js')}}"></script> <!--canvas need for ie-->

<!--plugins-->
<script src="{{asset('EndUserAssets/js/plugins/revslider/jquery.themepunch.tools.min.js')}}"></script> <!--revslider-->
<script src="{{asset('EndUserAssets/js/plugins/revslider/jquery.themepunch.revolution.min.js')}}"></script> <!--revslider-->

<!--menu-->
<script src="{{asset('EndUserAssets/js/plugins/menu/superfish.min.js')}}"></script> <!--superfish-->
<script src="{{asset('EndUserAssets/js/plugins/menu/tinynav.min.js')}}"></script> <!--tinynav-->

<!--other-->
<script src="{{asset('EndUserAssets/js/plugins/isotope/isotope.pkgd.min.js')}}"></script> <!--isotope-->
<script src="{{asset('EndUserAssets/js/plugins/mpopup/jquery.magnific-popup.min.js')}}"></script> <!--mpopup-->
<script src="{{asset('EndUserAssets/js/plugins/scroolto/scroolto.js')}}"></script> <!--Scrool To-->
<script src="{{asset('EndUserAssets/js/plugins/nicescrool/jquery.nicescroll.min.js')}}"></script> <!--Nice Scroll-->
<script src="{{asset('EndUserAssets/js/plugins/inview/jquery.inview.min.js')}}"></script> <!--inview-->
<script src="{{asset('EndUserAssets/js/plugins/parallax/jquery.parallax-1.1.3.js')}}"></script> <!--parallax-->
<script src="{{asset('EndUserAssets/js/plugins/countto/jquery.countTo.js')}}"></script> <!--jquery.countTo-->
<script src="{{asset('EndUserAssets/js/plugins/countdown/jquery.countdown.js')}}"></script> <!--countdown-->

<!--settings-->
<script src="{{asset('EndUserAssets/js/settings.js')}}"></script> <!--settings-->
<!--custom js-->
