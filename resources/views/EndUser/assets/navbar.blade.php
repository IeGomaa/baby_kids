...
<head>
    ...
    <!--START CSS-->
    <link rel="stylesheet" href="{{asset('EndUserAssets/css/nicdark_style.css')}}"> <!--style-->
    <link rel="stylesheet" href="{{asset('EndUserAssets/css/nicdark_responsive.css')}}"> <!--nicdark_responsive-->

    <!--revslider-->
    <link rel="stylesheet" href="{{asset('EndUserAssets/css/revslider/settings.css')}}"> <!--revslider-->
    ...
    <!--FAVICONS-->
    <link rel="shortcut icon" href="{{asset('EndUserAssets/img/favicon/favicon.ico')}}">
    <link rel="apple-touch-icon" href="{{asset('EndUserAssets/img/favicon/apple-touch-icon.png')}}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset('EndUserAssets/img/favicon/apple-touch-icon-72x72.png')}}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('EndUserAssets/img/favicon/apple-touch-icon-114x114.png')}}">
    <!--END FAVICONS-->
